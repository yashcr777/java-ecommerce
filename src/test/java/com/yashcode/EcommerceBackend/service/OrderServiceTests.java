...
class OrderServiceTest {
    ...
    void testPlaceOrder_EmptyCart() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> orderService.placeOrder(emptyCart.getId()));
    ...
    void testGetUserOrders_EmptyOrders() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> orderService.getUserOrders(user.getId()));
    }
